...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "23892")
    API_HASH  = os.environ.get("API_HASH", "da7e86cf7b0e6220b8a9e0a28a68")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6966079567:AZs_kK9VwPWXbZfjW6kpYq1Yv4TiRpbo") 
